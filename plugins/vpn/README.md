...
with `appearance: "accent"` instead of an icon-theme `icon` — larger and
tinted with the desktop's own system accent color, rather than a plugin-
supplied color. The menu shows the country code and available city/country
